...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ABS = 14,                       /* ABS  */
  YYSYMBOL_BitsL = 15,                     /* BitsL  */
  YYSYMBOL_BitsR = 16,                     /* BitsR  */
...
static const char *const yytname[] =
{
  ...
  "Number", "Equal", "Mult", "Div", "Pow", "PR", "PL", "MOD", "SQRT",
  "ABS", "BitsL", "BitsR", "$accept", "input", "line", "Exp", YY_NULLPTR
};
...
{
     -10,    17,   -10,   -10,   -10,    13,    13,    13,   -10,    29,
      39,    63,    49,    13,    13,   -10,    13,    13,    13,    13,
      13,    13,   -10,   -10,    73,    73,    75,    75,    75,    -9,
      63,    63
};
...
{
       2,     0,     1,     6,     4,     0,     0,     0,     3,     0,
       0,    13,     0,     0,     0,     5,     0,     0,     0,     0,
       0,     0,    17,    14,     7,     8,     9,    10,    11,    12,
      15,    16
};
...
{
      10,    11,    12,    19,     0,     0,    20,    21,    24,    25,
       0,    26,    27,    28,    29,    30,    31,     2,     3,     0,
       0,     0,     3,     4,     5,     0,     6,     7,     5,     0,
       6,     7,    13,    14,     0,    15,    16,    17,    18,     0,
       0,    19,    13,    14,    20,    21,    16,    17,    18,    22,
       0,    19,    13,    14,    20,    21,    16,    17,    18,     0,
       0,    19,     0,    23,    20,    21,    13,    14,     0,     0,
      16,    17,    18,     0,     0,    19,     0,     0,    20,    21,
      16,    17,    18,     0,    18,    19,     0,    19,    20,    21,
      20,    21
};

static const yytype_int8 yycheck[] =
{
       5,     6,     7,    12,    -1,    -1,    15,    16,    13,    14,
      -1,    16,    17,    18,    19,    20,    21,     0,     5,    -1,
      -1,    -1,     5,     6,    11,    -1,    13,    14,    11,    -1,
      13,    14,     3,     4,    -1,     6,     7,     8,     9,    -1,
      -1,    12,     3,     4,    15,    16,     7,     8,     9,    10,
      -1,    12,     3,     4,    15,    16,     7,     8,     9,    -1,
      -1,    12,    -1,    14,    15,    16,     3,     4,    -1,    -1,
       7,     8,     9,    -1,    -1,    12,    -1,    -1,    15,    16,
       7,     8,     9,    -1,     9,    12,    -1,    12,    15,    16,
      15,    16
};
...
{
       0,    18,     0,     5,     6,    11,    13,    14,    19,    20,
      20,    20,    20,     3,     4,     6,     7,     8,     9,    12,
      15,    16,    10,    14,    20,    20,    20,    20,    20,    20,
      20,    20
};
...
#line 1185 "parser.tab.c"
  ...
  case 14: /* Exp: ABS Exp ABS  */
#line 72 "parser.y"
                              {
                    				yyval = valorAbsoluto(yyvsp[-1]);
                    				}
#line 1193 "parser.tab.c"
    break;

  case 15: /* Exp: Exp BitsL Exp  */
#line 75 "parser.y"
                                {yyval = yyvsp[-2] << yyvsp[0];}
#line 1199 "parser.tab.c"
    break;

  case 16: /* Exp: Exp BitsR Exp  */
#line 76 "parser.y"
                                {yyval = yyvsp[-2] >> yyvsp[0];}
#line 1205 "parser.tab.c"
    break;

  case 17: /* Exp: PL Exp PR  */
#line 77 "parser.y"
                            {yyval = yyvsp[-1];}
